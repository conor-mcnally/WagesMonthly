...
def store():
    ...
    if(date == None):
        ...
        result = messagebox.askquestion("Submit, You are about to enter the following data: " + str(adate) + " " + str(aamount))
...
#Row 0 heading
lblHeading = Label(root, text = "Pay", font = ('Helvetica', 24, 'bold')).grid(row = 0, column = 0, columnspan = 4, padx = 20, pady = 10)

#Row 1 Components 
lblDate = Label(root, text = 'Date', font = ('Arial', 14, 'bold')).grid(row=1, column=1)
